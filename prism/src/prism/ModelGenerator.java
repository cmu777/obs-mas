...
public interface ModelGenerator extends ModelInfo
{
	...
	/**
	 * Get the transition label of a transition, specified by its index.
	 * The label can be any Object, but will often be treated as a string, so it should at least
	 * have a meaningful toString() method implemented. Absence of an transition label is denoted by null.
	 */
	public String getTransitionLabel(int i, int offset) throws PrismException;
	
	public String getAgent(int i, int offset) throws PrismException;
	//public String getObservation(int i, int offset) throws PrismException;
