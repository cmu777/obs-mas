...
public class ASTTraverse implements ASTVisitor
{
	...
	// -----------------------------------------------------------------------------------
	public void visitPre(Observation e) throws PrismLangException { defaultVisitPre(e); }
	public Object visit(Observation e) throws PrismLangException
	{
		visitPre(e);
		visitPost(e);
		return null;
	}
	public void visitPost(Observation e) throws PrismLangException { defaultVisitPost(e); }
	// -----------------------------------------------------------------------------------
	public void visitPre(ExpressionTransitionLabel e) throws PrismLangException { defaultVisitPre(e); }
	...
	public void visitPost(ExpressionTransitionLabel e) throws PrismLangException { defaultVisitPost(e); }
	// -----------------------------------------------------------------------------------
	public void visitPre(ExpressionAgent e) throws PrismLangException { defaultVisitPre(e); }
	...
	public void visitPost(ExpressionAgent e) throws PrismLangException { defaultVisitPost(e); }
	// -----------------------------------------------------------------------------------
	...
	// -----------------------------------------------------------------------------------
	@Override
	public Object visit(ProbTransLabel probTransLabel) {
		// TODO Auto-generated method stub
		return null;
	}
	
	@Override
	public Object visit(ProbTraceList probTraceList) throws PrismLangException {
		// TODO Auto-generated method stub
		return null;
	}
}
