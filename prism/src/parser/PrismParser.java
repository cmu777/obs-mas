...
// Expression: temporal operators, binary (U, W, O, R) and unary (X, F, G)
...
/*Expression ExpressionTransitionLabel(boolean prop, boolean pathprop) :
{
	String s;
...
}
{
	...
	( s=Identifier() )
	{ ret = new ExpressionTransitionLabel(s); return ret; }
}*/
