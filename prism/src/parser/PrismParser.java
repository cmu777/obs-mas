...
// Keyword denoting model type
  static final public ModelType ModulesFileType() throws ParseException {
    ...
    case PTA:
      ...
      break;
    case POMAS:
      jj_consume_token(POMAS);
                    modelType=ModelType.POMAS;
      break;
    default:
      jj_la1[12] = jj_gen;
      jj_consume_token(-1);
...
// Updates
  static final public Updates Updates() throws ParseException {
    ...
    if (jj_2_5(2147483647)) {
      update = Update();
                                                        updates.addUpdate(null, null, null, update);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case A:
      case E:
      ...
      case REG_IDENT:
        ...
        jj_consume_token(COLON);
        update = Update();
                  updates.addUpdate(prob, agent, tranLbl, update);
        label_8:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case PLUS:
...
// Agents and their observation on transition labels (actions)
  static final public void Agents(ModulesFile mf) throws ParseException {
        Agent agent = null;
        String name = null;
        Observation obs = null;
        String label = null;
        String obsLabel = null;
    jj_consume_token(AGENTS);
    // agent structure items
                    name = Identifier();
    jj_consume_token(COLON);
    label = Identifier();
    jj_consume_token(RARROW);
    obsLabel = Identifier();
                  agent = new Agent(name); mf.addAgent(agent); obs = new Observation (label, obsLabel); agent.addAction(obs);
    label_18:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
      ...
      jj_consume_token(RARROW);
      obsLabel = Identifier();
                          obs = new Observation (label, obsLabel); agent.addAction(obs);
    }
    jj_consume_token(SEMICOLON);
    label_19:
    while (true) {
    ...
    jj_consume_token(ENDAGENTS);
  }

// Observation on transition labels 

/*void Observations(ModulesFile mf) :
{
	Observation obs = null;
	String label = null;
	String obsLabel = null;
...
{
	(<OBSERVATIONS>
	( label = Identifier() <RARROW> obsLabel = Identifier() { obs = new Observation (label, obsLabel); mf.addObservation(obs); } 
	( <COMMA> label = Identifier() <RARROW> obsLabel = Identifier()  { obs = new Observation (label, obsLabel); mf.addObservation(obs); } )* )?
	<ENDOBSERVATIONS>)
}*/
...
// operator (reward R operator) or in the middle of a binary operator (release).
  ...
  static final public Expression ExpressionTemporalUnary(boolean prop, boolean pathprop) throws ParseException {
    ...
    case O:
      ...
      case O:
        jj_consume_token(O);
                        exprTemp.setOperator(ExpressionTemporal.P_O);
        break;
      case F:
        jj_consume_token(F);
...
// transition label
  static final public Expression ExpressionTransitionLabel(boolean prop, boolean pathprop) throws ParseException {
        String s;
        ExpressionTransitionLabel ret = null;
        Token begin;
          if (!prop) {if (true) throw generateParseException();}
    s = Identifier();
          ret = new ExpressionTransitionLabel(s); {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
...
// For loop
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x45100990,0x41100990,0x4000000,0xc0681088,0x0,0xc0681088,0xc0681088,0x0,0xc0681088,0x800,0x0,0x100,0x900,0x20000420,0x20000420,0x0,0x80,0x0,0x4000000,0x20000060,0x0,0x8000000,0x0,0x0,0x0,0x82e81008,0x0,0x0,0x0,0x82e81008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2800000,0x0,0x82e81008,0x82e81008,0x82e81008,0x82e81008,0x82e81008,0x0,0x0,0x0,0x0,0x0,0x0,0x80681008,0x0,0x0,0x0,0x0,0x0,0x0,0x80681008,0x80681008,0x0,0x80000000,0x80000000,0x0,0x80000,0x0,0x80000000,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x82e81008,0x82e81008,0x0,0x0,0x92e81208,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0x80000000,0x0,0x80000000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x187e15,0x83e11,0x104004,0x127a9c2,0x80000000,0x127a9c2,0x127a9c2,0x80000000,0x127a9c2,0x400,0x11,0x80000,0x81611,0x0,0x0,0x2800,0x2800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x12781ea,0x2000000,0x200000,0x0,0x12781ea,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc20000,0x0,0xc20000,0x28,0x0,0x12781ea,0x12781ea,0x12781ea,0x12781ea,0x12781ea,0x0,0x0,0x8000000,0x10000000,0x4000000,0x2000000,0x12781c2,0x0,0x0,0x0,0x0,0x0,0x0,0x2781c2,0x2781c2,0x0,0x2,0x2,0x0,0x200000,0x0,0x2,0x1c0,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x2,0x38000,0x0,0x12781ea,0x12781ea,0x0,0x40000,0x12781ea,0x0,0x381c0,0x381c0,0x0,0x0,0x0,0x0,0x0,0x6000002,0x0,0x2,0x0,0x0,0x40000000,};
   }
