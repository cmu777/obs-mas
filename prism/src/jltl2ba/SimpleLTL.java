...
public class SimpleLTL {
		...
		if (o instanceof SimpleLTL) {
			...
			if (kind == other.kind) {
				...
				case FALSE:case TRUE:
					return true;
				case NOT:case NEXT:case OPACITY:case GLOBALLY:case FINALLY:
	...
	public APSet getAPs()
	{
		...
		switch (kind) {
		case NOT:case NEXT:case OPACITY:
	...
	private SimpleLTL simplified()
	{
		...
		case NOT: case NEXT: case OPACITY: case FINALLY: case GLOBALLY:
	...
	public static SimpleLTL parseFormulaLBT(String formula) throws Exception
	{
		...
		unaryOps.put("O", SimpleLTL.LTLType.OPACITY);
