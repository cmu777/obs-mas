...
public class ModulesFileModelGenerator extends DefaultModelGenerator
{
	...
	public ModulesFileModelGenerator(ModulesFile modulesFile, PrismComponent parent) throws PrismException
	{
		...
		//observationList = modulesFile.getTranLblObservations();
		agentList = modulesFile.getAgents();
	...
	private void initialise() throws PrismLangException
	{
		...
		//transitionLabelList = new TransitionLabelList();
	}
	...
	@Override
	public String getTransitionLabel(int index, int offset) throws PrismException {
		TransitionList transLabels = getTransitionList();
		return transLabels.getChoice(index).getTransLabel(offset);
	}
	
	@Override
	public String getAgent(int index, int offset) throws PrismException {
		TransitionList transLabels = getTransitionList();
		return transLabels.getChoice(index).getAgent(offset);
	}
	
	/*@Override
	public String getObservation(int index, int offset) throws PrismException {
		TransitionList transLabels = getTransitionList();
		return transLabels.getChoice(index).getObservation(offset);
	}*/
	...
	//public List<Observation> createObservationList()
	//{
	//	return observationList;
	//}
