...
public class ChoiceListFlexi implements Choice
{
	...
	public ChoiceListFlexi()
	{
		...
		transLabel = new ArrayList<String>();
	...
	public ChoiceListFlexi(ChoiceListFlexi ch)
	{
		...
		transLabel = new ArrayList<String>(ch.size());
		for (String l : ch.transLabel) {
			transLabel.add(l);
		}
		
		agent = new ArrayList<String>(ch.size());
		for (String a : ch.agent) {
			agent.add(a);
		}
	 ...
	 * @param label Transition label of the transition
	 * @param ups List of Update objects defining transition
	 */
	public void add(double probability, String ag, String label, List<Update> ups)
	{
