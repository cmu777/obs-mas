/*
 * $Id: CMFieldElementUtil.java 4851 2014-06-28 18:35:46Z kredel $
 */
...
public class CMFieldElementUtil {
    ...
    public static <C extends RingElem<C>> FieldMatrix<CMFieldElement<C>> toCMFieldMatrix(GenMatrix<C> v) {
        ...
        FieldMatrix<CMFieldElement<C>> va = new BlockFieldMatrix<CMFieldElement<C>>(
                        CMFieldElementUtil.<C> toCMFieldElementFromMatrix(v.matrix));
        return va;
    }
     ...
     * 
     * @param <C> ring element type
     * @param v commons-math FieldVector of CMFieldElement objects
     * @return JAS vector of ring elements
     */
    public static <C extends RingElem<C>> GenVector<C> vectorFromCMFieldVector(GenVectorModul<C> fac,
     ...
     */
    public static <C extends RingElem<C>> GenMatrix<C> matrixFromCMFieldMatrix(GenMatrixRing<C> fac,
