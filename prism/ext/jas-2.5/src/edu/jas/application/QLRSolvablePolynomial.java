/*
 * $Id: QLRSolvablePolynomial.java 4676 2013-10-27 11:54:59Z kredel $
 */
...
/**
 * QLRSolvablePolynomial generic recursive solvable polynomials
 * implementing RingElem. n-variate ordered solvable polynomials over
 * solvable quotient, local and local-residue coefficients. Objects of
...
public class QLRSolvablePolynomial<C extends GcdRingElem<C> & QuotPair<GenPolynomial<D>>, 
     ...
     */
    protected QLRSolvablePolynomial(QLRSolvablePolynomialRing<C,D> r,
            ...
            for (Map.Entry<ExpVector, C> x : Bk) {
                ...
                if (ring.polCoeff.isCommutative() || b.isConstant() || e.isZERO()) { // symmetric
                    ...
                    if (b.denominator().isONE()) { // recursion base
                        ...
                        RecSolvablePolynomial<D> rsp2 = new RecSolvablePolynomial<D>(ring.polCoeff,b.numerator());
                        ...
                        if (debug)
                            logger.info("coeff-num: Cps = " + Cps + ", num = " + b.numerator() + ", den = " + b.denominator());
     ...
     */
    @Override
    public QLRSolvablePolynomial<C,D> multiply(C b, ExpVector e, C c,
                    ExpVector f) {
        if (b == null || b.isZERO()) {
            return ring.getZERO();
        }
    ...
    /**
     * QLRSolvablePolynomial multiplication. Left product with ring element
     * and exponent vector.
     * @param b coefficient polynomial.
     * @param e exponent.
    ...
    /**
     * QLRSolvablePolynomial multiplication. Left product with exponent
     * vector.
     * @param e exponent.
    ...
    /**
     * QLRSolvablePolynomial multiplication. Left product with coefficient
     * ring element.
     * @param b coefficient polynomial.
