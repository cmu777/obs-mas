/*
 * $Id: LocalSolvablePolynomialTest.java 4562 2013-08-04 20:39:23Z kredel $
 */
...
public class LocalSolvablePolynomialTest extends TestCase {
    ...
    /**
     * Constructs a <CODE>LocalSolvablePolynomialTest</CODE> object.
     * @param name String.
     */
    public LocalSolvablePolynomialTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(LocalSolvablePolynomialTest.class);
        return suite;
    }


    LocalSolvablePolynomial<BigRational> a, b, c, d, e, f, x1, x2;
    ...
    protected void setUp() {
        ...
        ring = new LocalSolvablePolynomialRing<BigRational>(qcring, tord, vars);
    ...
    public void testConstructor() {
        ...
        a = new LocalSolvablePolynomial<BigRational>(ring);
    ...
    public void testMultiplication() {
        ...
        d = (LocalSolvablePolynomial<BigRational>) a.monic();
    ...
    public void testCommutative() {
        ...
        sideal = new SolvableIdeal<BigRational>(cring, il);
        qcring = new SolvableLocalRing<BigRational>(sideal);
        ring = new LocalSolvablePolynomialRing<BigRational>(qcring, ring);
        //table = ring.table;
    ...
    public void testDistributive() {
        ...
        d = a.multiply((LocalSolvablePolynomial<BigRational>) b.sum(c));
        e = (LocalSolvablePolynomial<BigRational>) a.multiply(b).sum(a.multiply(c));
    ...
    public void testSolvableCoeffs() {
        ...
        ring = new LocalSolvablePolynomialRing<BigRational>(qcsring, ring);
        RelationGenerator<SolvableLocal<BigRational>> wl = new WeylRelations<SolvableLocal<BigRational>>();
        ring.addRelations(wl); //wl.generate(ring);
        assertTrue("# relations == 2", ring.table.size() == 2);
        ...
        b = (LocalSolvablePolynomial<BigRational>) b.inverse();
        ...
        e = (LocalSolvablePolynomial<BigRational>) b.inverse();
     ...
     * LocalSolvablePolynomialRing<BigRational> pfec = pfe.contract(k);
     * //System.out.println("pfec = " + pfec); assertEquals("ring == pfec",
     * ring, pfec);
     * 
     * LocalSolvablePolynomial<BigRational> a = ring.random(kl, ll, el, q);
     * //System.out.println("a = " + a);
     * 
     * LocalSolvablePolynomial<BigRational> ae =
     * (LocalSolvablePolynomial<BigRational>) a.extend(pfe, 0, 0);
     ...
     * //System.out.println("a = " + a);
     * 
     * LocalSolvablePolynomial<BigRational> ar =
     * (LocalSolvablePolynomial<BigRational>) a.reverse(pfr);
     * LocalSolvablePolynomial<BigRational> arr =
     * (LocalSolvablePolynomial<BigRational>) ar.reverse(pfrr);
     ...
     * LocalSolvablePolynomial<BigRational> ar, br, cr, dr; ad = sring.random(kl,
     ...
     * 
     * ar = (LocalSolvablePolynomial<BigRational>) PolyUtil.<BigRational>
     * recursive(rsring, ad); br = (LocalSolvablePolynomial<BigRational>)
     ...
     * 
     * dr = (LocalSolvablePolynomial<BigRational>) PolyUtil.<BigRational>
