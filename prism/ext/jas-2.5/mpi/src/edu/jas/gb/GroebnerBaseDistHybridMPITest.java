/*
 * $Id: GroebnerBaseDistHybridMPITest.java 4604 2013-08-25 16:59:02Z kredel $
 */
...
public class GroebnerBaseDistHybridMPITest extends TestCase {
    ...
    /**
     * Constructs a <CODE>GroebnerBaseDistHybridMPITest</CODE> object.
     * @param name String.
     */
    public GroebnerBaseDistHybridMPITest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(GroebnerBaseDistHybridMPITest.class);
        return suite;
    }
    ...
    GroebnerBaseDistributedHybridMPI<BigRational> bbdist;


    GroebnerBaseDistributedHybridMPI<BigRational> bbdists;
    ...
    protected void setUp() throws IOException {
        try {
            ...
            bbdist = new GroebnerBaseDistributedHybridMPI<BigRational>(threads, threadsPerNode);
            //bbdists = new GroebnerBaseDistributedHybridMPI<BigRational>(threads,threadsPerNode, new OrderedSyzPairlist<BigRational>());
     ...
     */
    public void onlyOnetestDistributedGBase() throws MPIException {
