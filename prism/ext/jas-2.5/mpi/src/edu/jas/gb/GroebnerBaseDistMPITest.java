/*
 * $Id: GroebnerBaseDistMPITest.java 4604 2013-08-25 16:59:02Z kredel $
 */
...
public class GroebnerBaseDistMPITest extends TestCase {
    ...
    /**
     * Constructs a <CODE>GroebnerBaseDistMPITest</CODE> object.
     * @param name String.
     */
    public GroebnerBaseDistMPITest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(GroebnerBaseDistMPITest.class);
        return suite;
    }
    ...
    GroebnerBaseDistributedMPI<BigRational> bbdist;


    GroebnerBaseDistributedMPI<BigRational> bbdists;
     ...
     */
    public void testDistributedGBase() throws MPIException {
