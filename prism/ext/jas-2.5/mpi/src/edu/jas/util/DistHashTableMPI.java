/*
 * $Id: DistHashTableMPI.java 4695 2013-11-09 19:37:39Z kredel $
 */
        ...
        try {
            ...
            for (int i = 1; i < size; i++) { // send not to self.listener
                if (useTCP) {
                    ...
                    synchronized (MPIEngine.class) { // do not remove
        ...
        while (goon) {
            ...
            try {
                ...
                if (DistHashTableMPI.useTCP) {
                    ...
                    Status stat = null;
                    synchronized (MPIEngine.class) { // do not remove global static lock, // only from 0:
